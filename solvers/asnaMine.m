function [A, output]=asnaMine(X,S,lambda,iterations,options)
%Slightly modified by Cassio F. Dantas 09/02/2023
% - Added time tracking per iteration
% - Optional duality gap computation
%
...
if calc_gap
    output.gap_it = zeros(1,iterations);
